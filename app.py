...
CLASS_LABELS = {
    ...
    "tomato": ['Tomato__Bacterial_spot', 'Tomato_Early_blight', 'Tomato__Late_blight',
               'Tomato__Leaf_Mold', 'Tomato_Septoria_leaf_spot', 'Tomato__Tomato_Yellow_Leaf_Curl_Virus',
